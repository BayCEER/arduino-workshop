...
const uint8_t adr[] = {0x46, 0xf0, 0xe3, 0xc4, 0x45}; // equals 0x45c4e3f046 little endian fromat
//channel map and unit map must not exceed 98 characters!
char channel_map[] = "time;bat;Ch1;Ch2";
char unit_map[] = "ms;V;Unit1,Unit2";
